module "consul_acl_controller" {
  ...
  consul_server_http_addr = "http://aws.private.consul.292e39b5-68d5-466c-a083-5eb1fe71a5ef.aws.hashicorp.cloud:8500"
...
module "mesh_gateway" {
  ...
  acls = true
  consul_http_addr = "http://aws.private.consul.292e39b5-68d5-466c-a083-5eb1fe71a5ef.aws.hashicorp.cloud:8500"
