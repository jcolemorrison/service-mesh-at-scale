module "consul_acl_controller" {
  ...
  consul_server_http_addr = "${data.hcp_consul_cluster.aws.consul_public_endpoint_url}:8501"
...
module "mesh_gateway" {
  ...
  acls = true
  consul_http_addr = "${data.hcp_consul_cluster.aws.consul_public_endpoint_url}:8501"
